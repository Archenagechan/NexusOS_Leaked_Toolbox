...
namespace Nexus_LiteOS_ToolKit_GUI
{
    public partial class PP : Form
    {
        ...
        private void PP_Load(object sender, EventArgs e)
        {
            ...
            dl.DownloadFileAsync(new Uri("https://t1.daumcdn.net/potplayer/PotPlayer/Version/Latest/PotPlayerSetup64.exe"), "C:\\Nexus_LiteOS_ToolKit\\Downloads\\PotPlayerSetup64.exe");
        }
