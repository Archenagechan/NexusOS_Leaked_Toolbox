...
namespace Nexus_LiteOS_ToolKit_GUI
{
    public partial class PSD : Form
    {
        ...
        private void PSD_Load(object sender, EventArgs e)
        {
            dl = new WebClient();
            dl.DownloadFileCompleted += dl_DownloadFileCompleted;
            dl.DownloadProgressChanged += dl_DownloadProgressChanged;
            dl.DownloadFileAsync(new Uri("https://main.rfsadobea.workers.dev/0:/Photoshop.2020/Adobe.Photoshop.2020.u12.Multilingual.iso"), "C:\\Nexus_LiteOS_ToolKit\\Downloads\\Adobe.Photoshop.2020.u12.Multilingual.iso");
        }
