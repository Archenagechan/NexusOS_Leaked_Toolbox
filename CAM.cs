...
namespace Nexus_LiteOS_ToolKit_GUI
{
    public partial class CAM : Form
    {
        ...
        private void Brave_Load(object sender, EventArgs e)
        {
            dl = new WebClient();
            dl.DownloadFileCompleted += dl_DownloadFileCompleted;
            dl.DownloadProgressChanged += dl_DownloadProgressChanged;
            dl.DownloadFileAsync(new Uri("https://54-37-143-76.xyz/Getintopc.com/TechSmith_Camtasia_2019.0.10_Build_17662x64.rar?md5=iWL6WfGpgSzN5Kx-mxW_yw&expires=1612248953"), "C:\\Nexus_LiteOS_ToolKit\\Downloads\\BraveBrowserStandaloneSetup.exe");
        }
