...
namespace Nexus_LiteOS_ToolKit_GUI
{
    public partial class ILL : Form
    {
        ...
        private void ILL_Load(object sender, EventArgs e)
        {
            dl = new WebClient();
            dl.DownloadFileCompleted += dl_DownloadFileCompleted;
            dl.DownloadProgressChanged += dl_DownloadProgressChanged;
            dl.DownloadFileAsync(new Uri("https://main.rfsadobea.workers.dev/0:/Illustrator.2020/Adobe.Illustrator.2020.u10.Multilingual.iso"), "C:\\Nexus_LiteOS_ToolKit\\Downloads\\Adobe.Illustrator.2020.u10.Multilingual.iso");
        }
