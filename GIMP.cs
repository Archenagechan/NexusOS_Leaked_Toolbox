...
namespace Nexus_LiteOS_ToolKit_GUI
{
    public partial class GIMP : Form
    {
        ...
        private void GIMP_Load(object sender, EventArgs e)
        {
            dl = new WebClient();
            dl.DownloadFileCompleted += dl_DownloadFileCompleted;
            dl.DownloadProgressChanged += dl_DownloadProgressChanged;
            dl.DownloadFileAsync(new Uri("http://s2.softlay.net/files/gimp-2.8.14.zip?st=WRWLSvZT2gck9ILVQrppSw&e=1609702874&a=2409:4056:18f:8aee:dc8c:c90d:eea8:b019"), "C:\\Nexus_LiteOS_ToolKit\\Downloads\\gimp-2.8.14.zip");
        }
