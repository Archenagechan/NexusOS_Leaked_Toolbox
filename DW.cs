...
namespace Nexus_LiteOS_ToolKit_GUI
{
    public partial class DW : Form
    {
        ...
        private void DW_Load(object sender, EventArgs e)
        {
            ...
            dl.DownloadFileAsync(new Uri("https://main.rfsadobea.workers.dev/0:/Dreamweaver.2020/Adobe.Dreamweaver.2020.u1.Multilingual.iso"), "C:\\Nexus_LiteOS_ToolKit\\Downloads\\Adobe.Dreamweaver.2020.u1.Multilingual.iso");
        }
