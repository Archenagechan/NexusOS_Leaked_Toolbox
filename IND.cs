...
namespace Nexus_LiteOS_ToolKit_GUI
{
    public partial class IND : Form
    {
        ...
        private void IND_Load(object sender, EventArgs e)
        {
            dl = new WebClient();
            dl.DownloadFileCompleted += dl_DownloadFileCompleted;
            dl.DownloadProgressChanged += dl_DownloadProgressChanged;
            dl.DownloadFileAsync(new Uri("https://main.rfsadobea.workers.dev/0:/InDesign.2020/Adobe.InDesign.2020.u6.Multilingual.iso"), "C:\\Nexus_LiteOS_ToolKit\\Downloads\\Adobe.InDesign.2020.u6.Multilingual.iso");
        }
