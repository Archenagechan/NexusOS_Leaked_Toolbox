...
namespace Nexus_LiteOS_ToolKit_GUI
{
    public partial class Discord : Form
    {
        ...
        private void Discord_Load(object sender, EventArgs e)
        {
            ...
            dl.DownloadFileAsync(new Uri("https://dl.discordapp.net/apps/win/0.0.309/DiscordSetup.exe"), "C:\\Nexus_LiteOS_ToolKit\\Downloads\\DiscordSetup.exe");
        }
        ...
        private void dl_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            string termination = (e.Cancelled == true) ? " Cancelled" : " Finished! NOW JOIN MY DISCORD SERVER!!";
