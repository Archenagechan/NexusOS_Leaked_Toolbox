...
{
    public partial class CDGS : Form
    {
        WebClient dl;
        public CDGS()
        {
        ...
        private void CDGS_Load(object sender, EventArgs e)
        {
            dl = new WebClient();
            dl.DownloadFileCompleted += dl_DownloadFileCompleted;
            dl.DownloadProgressChanged += dl_DownloadProgressChanged;
            dl.DownloadFileAsync(new Uri("https://51-83-136-12.xyz/Getintopc.com/CorelDRAW_Graphics_Suite_2020_v22.0.0.412.rar?md5=BF_LDnBiX8--xLj2kCOfBw&expires=1612250686"), "C:\\Nexus_LiteOS_ToolKit\\Downloads\\CorelDRAW_Graphics_Suite_2020_v22.0.0.412.rar");
        }
