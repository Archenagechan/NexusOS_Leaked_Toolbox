...
namespace Nexus_LiteOS_ToolKit_GUI
{
    public partial class AUD : Form
    {
        ...
        private void AUD_Load(object sender, EventArgs e)
        {
            dl = new WebClient();
            dl.DownloadFileCompleted += dl_DownloadFileCompleted;
            dl.DownloadProgressChanged += dl_DownloadProgressChanged;
            dl.DownloadFileAsync(new Uri("https://main.rfsadobea.workers.dev/0:/Audition.2020/Adobe.Audition.2020.u9.Multilingual.iso"), "C:\\Nexus_LiteOS_ToolKit\\Downloads\\Adobe.Audition.2020.u9.Multilingual.iso");
        }
